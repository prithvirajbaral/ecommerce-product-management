...
const UpdateProduct = () => {
  ...
  const [image, setImage] = useState(null); // Use null instead of undefined for better clarity
  ...
  const handleSubmit = async (e) => {
    ...
    axios
      .put(`http://localhost:8081/api/products/update/${id}`, updatedProduct, {
        headers: {
        ...
        <form className="row g-3 pt-5" onSubmit={handleSubmit}>
          ...
          <div className="col-12">
            ...
            <input
              type="text"
              className="form-control"
              placeholder={product.description || "Enter desp"}
              name="description"
              onChange={handleChange}
